...
thisFunctionality = [
  ...
  'arguments': [
    ...
    [
      ...
      'type': 'file',
      'direction': 'output',
      'default': '$id.$key.molecule_info.h5',
...
thisHelpMessage = '''split_10x_dir main_build
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/utilities/convert_split_10x_dir",
    "tag" : "main_build"
  }
}"""),
  // auto settings
