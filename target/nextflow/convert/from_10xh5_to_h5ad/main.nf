...
thisHelpMessage = '''from_10xh5_to_h5ad main_build

Converts a 10x h5 into an h5ad file.
...
Options:
    ...
    --gex_only
        type: boolean_true
        Only keep 'Gene Expression' data and ignore other feature types, e.g.
'Antibody Capture', 'CRISPR Guide Capture', or 'Custom'.'''
...
par = {
  ...
  'gex_only': $( if [ ! -z ${VIASH_PAR_GEX_ONLY+x} ]; then echo "'${VIASH_PAR_GEX_ONLY//\\'/\\\\\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/utilities/convert_from_10xh5_to_h5ad",
    "tag" : "main_build"
  }
}"""),
  // auto settings
