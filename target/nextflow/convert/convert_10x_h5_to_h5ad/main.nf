// convert_10x_h5_to_h5ad main_build
// 
...
thisHelpMessage = '''convert_10x_h5_to_h5ad main_build
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/utilities/convert_convert_10x_h5_to_h5ad",
    "tag" : "main_build"
  }
}"""),
  // auto settings
