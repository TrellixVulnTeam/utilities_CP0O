// convert_10x_h5_to_h5mu main_build
// 
...
thisFunctionality = [
  ...
  'arguments': [
    [
      ...
      'type': 'file',
      'direction': 'input',
      'description': 'Output h5 from a Cell Ranger count run.',
    ...
    [
      ...
      'type': 'file',
      'direction': 'output',
      'description': 'Counts in MuData format.',
...
thisHelpMessage = '''convert_10x_h5_to_h5mu main_build

Options:
    --input
        type: file, required parameter
        example: filtered_feature_bc_matrix.h5
        Output h5 from a Cell Ranger count run.

    --output
        type: file, required parameter, output
        example: output.h5mu
        Counts in MuData format.'''
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/utilities/convert_convert_10x_h5_to_h5mu",
    "tag" : "main_build"
  }
}"""),
  // auto settings
