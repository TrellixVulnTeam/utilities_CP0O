// sync_resources_test main_build
// 
...
thisFunctionality = [
  ...
  'arguments': [
    [
      ...
      'default': 's3://czbiohub-pipelines/utilities',
      'multiple': false
    ],
    [
      'name': 'output',
...
thisHelpMessage = '''sync_resources_test main_build

Synchronise the test resources from s3://czbiohub-pipelines/utilities to
resources_test

Usage:
sync_resources_test
sync_resources_test --input s3://czbiohub-pipelines/utilities --output
resources_test
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/utilities/download_sync_resources_test",
    "tag" : "main_build"
  }
}"""),
  // auto settings
