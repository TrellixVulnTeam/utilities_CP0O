...
thisHelpMessage = '''download_basespace main_build
...
Options:
    ...
    --output
        ...
        example: path_to_dir
        Path where to store BCL output.
    ...
    --compress
        type: boolean_true
        Write gzipped tar archive.

    --overwrite
        type: boolean_true
        Overwrite files that already exist and have the same file size
    ...
    --api_server
        type: string
        default: https://api.basespace.illumina.com
        BaseSpace API hostname

    --access_token
        type: string
        default: 610b74406284445fa38691d551c30e4a
        Manual BaseSpace API access token'''
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/utilities/download_download_basespace",
    "tag" : "main_build"
  }
}"""),
  // auto settings
